...
<body>
	...
	<div class="container">
		<div class="row justify-content-center"> 
			...
			<div class="formCss">
				<form action="${pageContext.request.contextPath}/processAddSchedule"
				      method="post" enctype="multipart/form-data">
				  <div class="visibility">
				    <label title="비공개로 설정">
				      <input type="checkbox" id="visibility" name="visibility" value="N"><!-- 체크=비공개 -->
				  ...
				  <div class="mb-3 row g-3 justify-content-center">
				    ...
				    <div class="col-sm-5">
				      <input type="text" id="demo" name="demo" class="form-control" required />
				    </div>
				  </div>
				  ...
				  <div class="mb-3 row justify-content-center">
				    ...
				    <div class="col-sm-5 d-flex align-items-center gap-2">
				      <input type="text" id="member" class="form-control" placeholder="닉네임 입력">
				  ...
				  <div class="mb-3 row justify-content-center">
				    ...
				    <!-- 여기 안에 name='travelBuddies' hidden들이 동적으로 추가됨 -->
				  </div>
