...
$(function () {
  ...
  // hidden input에서 초기 날짜 값을 읽어옴
  const initialStartDateStr = $start.val();
  const initialEndDateStr = $end.val();
  ...
  $view.daterangepicker({
    ...
    startDate: initialStartMoment,
    endDate: initialEndMoment,
  ...
  // '초기값 셋팅' 블록을 'today' 대신 읽어온 값으로 설정
