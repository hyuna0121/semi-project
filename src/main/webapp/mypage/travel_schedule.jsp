   ...
   <div class="modal fade" id="eventModal" tabindex="-1"
      ...
      aria-label="닫기"></button>
         ...
         <div class="modal-footer">
               <button type="button" class="btn btn-primary" id="goToDetailsBtn" data-schedule-id="">
                   <span class="material-symbols-outlined align-middle me-1">calendar_month</span> 상세 일정 보기
               </button>
